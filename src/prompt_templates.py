...
class PromptTemplates:
    ...
    def modify_message_with_verbs(self, seed_messages, seed_verbs):
        ...
        with open(seed_verbs, 'r') as verbs_input_file, open(verbs_output_file, 'w') as verbs_output_file:
    ...
    def modify_message_with_variables(self, seed_messages, seed_verbs, seed_variables):
        #formatter = FormatSeedPromptData()
        modified_messages_verbs = self.modify_message_with_verbs(self, seed_messages, seed_verbs)
